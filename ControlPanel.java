 ...
 * Revision 1.6  2001/08/05 21:59:09  rayo
 * now places panel in middle of screen by default, and
 * requests focus after init
 *
 * Revision 1.4  2001/07/30 03:48:24  rayo
 * swapped locations for resource and process
 *
 */
...
try {
    ...
    else if ( e.target == stepButton )
    {
      if ( ! hasBeenReset )
        {
        kernel.reset() ;        hasBeenReset = true ;
        }
